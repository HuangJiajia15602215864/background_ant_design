  ...
  <div class="main user-layout-register">
    <a-form ref="formRegister" :form="form" id="formRegister">
      ...
      <a-popover placement="rightTop" :trigger="['focus']" :getPopupContainer="(trigger) => trigger.parentElement"
        ...
        <a-form-item>
          <a-input-password size="large" @click="handlePasswordInputClick" placeholder="至少6位密码，区分大小写"
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        form: this.$form.createForm(this),// 表单组件
        state: {
          time: 60,
          smsSendBtn: false,
          passwordLevel: 0,
    ...
    computed: {
      passwordLevelClass() {// 密码强度字体颜色
        return levelClass[this.state.passwordLevel]
      },
      passwordLevelName() {// 密码强度等级
        return levelNames[this.state.passwordLevel]
      },
      passwordLevelColor() {// 密码进度条颜色
